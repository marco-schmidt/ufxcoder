...
public final class FieldDescriptionFactory
{
  ...
  private static final FieldDescription[] ALL =
  {
      ...
      PHOTOMETRIC_INTERPRETATION, THRESHHOLDING, CELL_WIDTH, CELL_LENGTH, FILL_ORDER, IMAGE_DESCRIPTION, MAKE, MODEL,
      STRIP_OFFSETS, ORIENTATION, ROWS_PER_STRIP, STRIP_BYTE_COUNTS, MIN_SAMPLE_VALUE, MAX_SAMPLE_VALUE, X_RESOLUTION,
      Y_RESOLUTION, PLANAR_CONFIGURATION, FREE_OFFSETS, FREE_BYTE_COUNTS, RESOLUTION_UNIT, SOFTWARE, DATE_TIME, ARTIST,
      HOST_COMPUTER, PREDICTOR, COLOR_MAP, TILE_WIDTH, TILE_LENGTH, TILE_OFFSETS, TILE_BYTE_COUNTS,
